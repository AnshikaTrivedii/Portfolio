  ...
  return (
    <div>
      <div name="home" className="w-full h-screen bg-[#0a192f]">
        {/*container */}
        <div className="max-w-[1000px] mx:auto px-8 flex flex-col justify-center md:ml-20 h-full">
          ...
          <p className="text-[#8892b0] py-4 max-w-[700px]">
            I'am a full stack developer specializing in building .Currently.I'am
